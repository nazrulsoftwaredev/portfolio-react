...
import { createMessage, getMessageById, getMessages, updateMessage, } from "../services/messageService.js";
const router = Router();
...
router.get("/:id", async (req, res) => {
    try {
        ...
        if (error instanceof z.ZodError) {
            return sendError(res, 400, "VALIDATION_ERROR", "Invalid message ID", error.issues);
        }
