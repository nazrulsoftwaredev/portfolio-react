import { InquiryModel, InquiryDocument } from "../models/Inquiry.js";
import { PortfolioProjectModel } from "../models/PortfolioProject.js";
import { TestimonialModel } from "../models/Testimonial.js";

export const createInquiry = async (data: Partial<InquiryDocument>) => {
  const inquiry = new InquiryModel(data);
  return await inquiry.save();
};

export const getInquiries = async (query: any, limit: number, skip: number) => {
